...
export default async function CustomersPage() {
  ...
  return (
    <div className="grid gap-5">
      <div>
        <p className="text-sm font-bold text-[#647067]">Profiles created by checkout</p>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <MetricCard label="VIP segment" value={String(vip)} detail="High value customers" />
        <MetricCard label="Total LTV" value={money(ltv)} detail="Demo revenue attribution" />
      </div>
      <section className="overflow-hidden rounded-lg border border-[#dfe7df] bg-white">
        <div className="overflow-x-auto p-4">
          <table className="w-full min-w-[720px] text-sm">
            <thead className="text-left text-xs uppercase text-[#647067]"><tr><th className="py-2">Customer</th><th>Email</th><th>Tags</th><th>LTV</th><th>Orders</th><th>Status</th></tr></thead>
            <tbody>
