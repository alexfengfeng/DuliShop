...
CREATE TABLE "Product" (
    ...
    "mediaColor" TEXT NOT NULL DEFAULT '#e8f2dd',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ThemeConfig_storeId_key_key" ON "ThemeConfig"("storeId", "key");

-- CreateIndex
CREATE UNIQUE INDEX "AppInstallation_storeId_appKey_key" ON "AppInstallation"("storeId", "appKey");
